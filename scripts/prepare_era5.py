...
def main():
    ...
    era5_columns = [("2m_dewpoint_temperature","d2m"), ("surface_pressure","sp"), ("surface_solar_radiation_downwards","ssrd"),
                    ("2m_temperature","t2m"), ("total_precipitation","tp")]
    ...
    for column, abrev  in era5_columns:
        for index, row in df.iterrows():

            timespan = '1D'
            raw_filename = "era5_"+column+"_timeseries_"+row['cidade'].lower()+".nc"
            interim_filename = "era5_"+column+"_timeseries_" + row['cidade'].lower() + "_" + timespan + ".nc"
